...
"""
Laucher to run pix2pix baseline.

Sample commands: python -m experiments SingleG_AllMaterials_baseline_pix2pix launch 0,1
python -m experiments SingleG_AllMaterials_baseline_pix2pix launch_test 0,1
