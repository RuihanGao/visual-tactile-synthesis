...
import os, sys
sys.path.append("thirdparty/mmgeneration")
from positional_encoding import CatersianGrid as CSG
from positional_encoding import SinusoidalPositionalEmbedding as SPE


"""Ref: https://github.com/open-mmlab/mmgeneration/blob/5f35b8c876df8e2a8fb24aa8d674dd03907d251c/tests/test_modules/test_pe.py"""
