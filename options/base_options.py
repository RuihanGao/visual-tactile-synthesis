...
class BaseOptions:
    ...
    def initialize(self, parser):
        ...
        # model parameters
        parser.add_argument("--model", type=str, default="sinskit", help="chooses which model to use.")
        ...
        parser.add_argument(
            ...
            type=str,
            default="basic",
            choices=["basic", "n_layers", "pixel", "patch", "tilestylegan2", "stylegan2", "multiscale"],
        ...
        parser.add_argument(
            "--no_dropout", type=util.str2bool, nargs="?", const=True, default=True, help="no dropout for the generator"
        )
        parser.add_argument(
            "--no_antialias",
            action="store_true",
        ...
        ##### options for visualization copied from train_options.py #####
        ...
        parser.add_argument(
            "--display_id", type=int, default=None, help="window id of the web display. Default is random window id"
        )
        parser.add_argument(
        ...
        parser.add_argument(
            "--update_html_freq", type=int, default=10000, help="frequency of saving training results to html"
        )
        parser.add_argument(
            "--update_html_epch_freq",
            type=int,
            default=50,
            help="minimal frequency of number of epoch of saving training results to html",
        )
        parser.add_argument(
        ...
        ##### options copied from test.py so that we can save intermediate training results in the same directory #####
